 ...
 *
 * 'ไม่ซ่อมส่งรถกลับ(ติดต่อ903)' เป็นอีกทางจบของงาน คู่กับ 'ซ่อมเสร็จแล้ว' — ใช้ตอนไม่รับซ่อม
 * แล้วส่งรถกลับสาขาแทน ให้ติดต่อเบอร์ต่อ 903 ต่อ
 *
...
/** สถานะไม่รับซ่อม ส่งรถกลับสาขา — จบงานเหมือนกัน แต่ไม่ใช่ "เสร็จ" จึงไม่ประทับ RepairDoneAt */
